...
public class rodCuttingMemoized {
    static int t[][] = new int[9][9]; //Global Array for the purpose of memoization.
                            ...
                            int Max_len, int n)
    {
        ...
        // If the length of the rod is less than the maximum length, Max_lene will consider it.Now depending
        // upon the profit, either Max_lene  we will take it or discard it.
        ...
        // Max_lene Max_lenill return the maximum value obtained, Max_lenhich is present
